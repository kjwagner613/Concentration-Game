...
function checkResults(timeIsUp = false) {
  ...
  if (timeIsUp) {
    if (correctCount < 2) {
      resultsDiv.innerHTML = `<b>Time's up, you have ${correctCount} correct, you need at least two, sorry you lose.</b>`;
    } else {
      resultsDiv.innerHTML = `<b>Time's up, Congratulations you have ${correctCount} correct! You Win!</b>`;
    }
  } else if (correctCount === 3) {
    resultsDiv.innerHTML = `<b>Perfect! You got all three within your allotted time!!! Winner!!!!</b>`;
  } else if (selectedPictures.length === 3 && correctCount < 2) {
    resultsDiv.innerHTML = `<b>You got ${correctCount} out of 3 correct. Sorry, you lose.</b>`;
  } else {
    resultsDiv.innerHTML = `<b>Congratulations you have ${correctCount} correct! You Win!</b>`;
  }
